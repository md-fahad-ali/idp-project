...
const Navbar = ({
  ...
  return (
    <nav className={`fixed w-full z-50 ${pathname === '/' ? 'bg-opacity-30 bg-transparent backdrop-blur-md' : 'bg-[var(--navbar-bg)]'} text-[var(--navbar-text)] transition-colors duration-300`}>
      {/* Desktop Menu */}
      ...
      {/* Mobile Menu Button */}
      <div className={`md:hidden flex justify-between items-center px-4 py-3 ${pathname === '/' ? 'bg-opacity-30 bg-transparent backdrop-blur-md' : ''}`}>
